    ...
    <div id="page-wrapper">
        ...
        <section id="intro" class="page-section">
            <div class="inner">
                ...
                <div class="actions">
                    <a href="../views/project1.php" class="action-button action-button-line">previous work</a>
                    <a href="../views/home.php#contact" class="action-button action-button-line">Contact me</a>
                    <a href="../views/project3.php" class="action-button action-button-line">Movie'time</a>
                </div>
            </div>
        </section>
    </div>
